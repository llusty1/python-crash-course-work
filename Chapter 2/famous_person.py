#This exercise is meant to list two variables famous_person and message then we print it out!
famous_person = "Albert Einstein"
message = "once said, 'The person who never made a mistake never tried anything new."
